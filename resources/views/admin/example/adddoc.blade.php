...
<link rel="stylesheet" href="{{URL::asset('static/js/libs/jquery-tags-input/jquery.tagsinput.min.css')}}">
<body>
...
<!--标签插件-->
<script src="{{URL::asset('static/js/libs/jquery-tags-input/jquery.tagsinput.min.js')}}"></script>
